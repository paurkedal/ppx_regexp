## v0.5.2 - 2026-07-13
  ...
  - Fix compatibility with ppxlib >= 0.36 and OCaml 4.11-5.5 (PR #18 by
    Chris A).
...
## v0.4.3 - 2019-11-25
  ...
  - Extended compiler support to 4.02.3 up to 4.09.0 (at least) for both
    PPXes.
...
## v0.3.1 - 2017-08-21
  ...
  - Fix accidental shadowing of open from another interface-less module
    using `ppx_regexp`.
